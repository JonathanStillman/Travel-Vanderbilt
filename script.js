...
var yelpURL = "http://api.yelp.com/v3/businesses/search?location=nashville";
...
$.ajax({
    ...
    beforeSend: function (xhr) {
        xhr.setRequestHeader('Authorization', 'Bearer MJ5-bJhkCujBxJVttLJ0vxzLgs5ge3wRewkDm32IiqjBo69dYZkqZ-oz679UL0x0bTYNRiJHmfBO1JXrB8W7b4djrkYhgMFUgpRmcdhcy4NMbz7SSqbEhpeDo8NiX3Yx');
    },
    success: function (data) {
        console.log(data)
    }
